...
const Mission = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              To make cooking easier, quicker, and more enjoyable by creating instant food
              solutions without compromising authenticity. We believe that everyone deserves
              to enjoy delicious, home-cooked meals without spending hours in the kitchen.
            </p>
            <div className="mt-8 p-6 bg-white rounded-2xl shadow-lg">
              <p className="text-gray-700 italic">
                "At Fudsy, we're passionate about bringing the joy of cooking back to your kitchen
                by eliminating the tedious prep work and letting you focus on what matters most -
                creating memorable meals for your loved ones."
              </p>
            </div>
          </div>
